...
import { SplashScreen } from './assets/splash-screen';
...
export default function MapScreen() {    
    ...
    // novo estado para o input de minutos (string para TextInput)
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerSide}>
                    <TouchableOpacity onPress={() => setMenuTopRight(prev => !prev)}>
            ...
            <View style={styles.menuBar}>
                ...
                <TouchableOpacity style={styles.menuBarItem} onPress={() => { setSelectedSpot('Minhas Vagas'); }}>
                    <Ionicons name="car-sport" size={18} color="#fff" />
                    <Text style={styles.menuBarText}>Vagas</Text>
                </TouchableOpacity>
            ...
            {menuOpen && (
                <View style={styles.menuOverlay}>
                    <View style={styles.menu}>
                        ...
                        <TouchableOpacity style={styles.menuItem} onPress={() => { setMenuOpen(false); setSelectedSpot('Minhas Vagas'); }}>
                            <Ionicons name="car-sport" size={18} color="#555" />
                            <Text style={styles.menuItemText}>Minhas Vagas</Text>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity style={styles.menuItem} onPress={() => { setMenuOpen(false); }}>
                            <Ionicons name="settings" size={18} color="#555" />
            ...
            {menuTopRight && (
                <View style={styles.topRightMenu}>
                    <TouchableOpacity style={styles.topRightItem} onPress={() => { setMenuTopRight(false); setSelectedSpot('Perfil'); }}>
                        <Text style={styles.topRightText}>Perfil</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.topRightItem} onPress={() => { setMenuTopRight(false); setSelectedSpot('Notificações'); }}>
                        <Text style={styles.topRightText}>Notificações</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.topRightItem} onPress={() => { setMenuTopRight(false); }}>
                        <Text style={styles.topRightText}>Sair</Text>
                    </TouchableOpacity>
                </View>
            )}
            ...
            >
                ...
                >
                    <Image source={require('./assets/vagaa.png')} style={{ width: 28, height: 28 }} />
                </Marker>
            ...
            <View style={styles.bottomSheet}>
                ...
                {/* Input para definir minutos antes de iniciar sessão */}
                ...
                <TouchableOpacity style={styles.spotItem} onPress={() => handleSelectSpot('Vaga 1')}>
                    <Image
                        source={require('./assets/logoOn.png')}
                        style={{
                            width: 24,
                            height: 24,
